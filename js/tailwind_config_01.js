tailwind.config = {
    ...
    theme: {
        extend: {
            colors: {
                primary: "#EF4444", // Comic Red
                "background-light": "#F3F4F6", // Light Gray/White
            ...
            keyframes: {
                ...
                // --- DEFINICIÓN NUEVAS ANIMACIONES ---
                moleculeDrift: {
                    '0%, 100%': {
                        transform: 'translateX(0px) translateY(0px) rotate(0deg)',
                        filter: 'drop-shadow(0 0 5px rgba(59, 130, 246, 0.5))' // Brillo Azul
                    },
                    '50%': {
                        transform: 'translateX(10px) translateY(5px) rotate(2deg)',
                        filter: 'drop-shadow(0 0 15px rgba(59, 130, 246, 0.8))' // Brillo intenso
                    },
                },
                subtleGlow: {
                ...
                // --- FIN DEFINICIÓN NUEVAS ANIMACIONES ---
            }
        },
    },
};