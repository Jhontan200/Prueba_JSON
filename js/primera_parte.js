...
// Función para abrir/cerrar los poderes adicionales (Toggle)
...
function populateModal(hero, index, style) {
    ...
    // --- CORRECCIÓN: Título no se tapa con la X ---
    const titleElement = document.getElementById(`modal-${modalId}-title`);
    titleElement.classList.add('pr-16', 'block'); // Añade espacio de seguridad para la X
    ...
    // --- CORRECCIÓN: Botón de Toggle al lado del título ---
    // Buscamos o creamos el contenedor del header de poderes
